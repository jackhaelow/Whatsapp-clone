...
export default function UsersMenu({
  ...
  return (
    <div className="str-chat absolute  z-10 h-full w-full overflow-y-auto border-e border-e-[#DBDDE1] bg-green-300 dark:border-e-gray-800  dark:bg-[#17191c]">
      <div className="flex flex-col p-3">
        <div className=" front-bold mb-3  flex items-center gap-3 text-lg">
          <ArrowLeft onClick={onClose} className="cursor-pointer" /> Users
        </div>
        <input
          type="search"
          placeholder="Search users"
          className="rounded-full border border-blue-600 px-4 py-2 bg-transparent dark:bg-green-100 dark:text-black"
          value={searchInput}
...
function UserResult({
  ...
  return (
    ...
    >
      ...
      {user.online && <span className="text-xs text-black">Online</span>}
    </button>
  );
}
...
function StartGroupChatHeader({
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-col gap-3 bg-green-800 p-3 shadow-sm dark:bg-[#17191c]">
      <input
        placeholder="Group name"
        className="rounded border border-blue-700 p-2 bg-transparent  dark:border-green-600 dark:text-white"
      ...
      <div className="flex justify-center gap-2">
        ...
        <Button
          ...
          className="bg-green-400 py-2 active:bg-green-700"
        >
          Clear selection
        </Button>
      </div>
